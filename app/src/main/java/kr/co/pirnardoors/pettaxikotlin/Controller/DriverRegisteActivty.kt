...
import kotlinx.android.synthetic.main.activity_driver_registe.*
...
class DriverRegisteActivty : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_driver_registe)
